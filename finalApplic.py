        ...
        with open("resultfinale1.txt" , "w+") as f:
            ...
            while line  :
                if  line.startswith('min') or 'min' in line:
                    ...
                    line = g.readline()
                    pass 
                elif   '19.TX_VERIFY EVM MASK POWER SPECTRUM 5530 MCS13 EHT_MU BW-80 ANT2 _step ' in line or  '29.TEST_VERIFY EVM MASK POWER SPECTRUM 2412 MCS11 HE_SU BW-20 ANT1 _step' in line  or line.startswith('29.TEST_VERIFY EVM MASK POWER SPECTRUM 2412 MCS11 HE_SU BW-20 ANT1 _step'):
                    line=g.readline()
